...
from .resnet_cbm_wrapper import initialize_resnet_cbmw_from_config, ResnetCbmWrapper
...
def hypertune_resnet_cbm(cbm_configuration_path: Union[str, Path], 
    ...
    cbm_config['dropout'] = dropout_options
