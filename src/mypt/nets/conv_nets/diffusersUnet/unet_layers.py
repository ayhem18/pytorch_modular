...
from mypt.building_blocks.conv_blocks.conditioned.resnet_con_block import (
    ConditionalWResBlock,
    DownCondWResnetBlock,
    UpCondWResnetBlock
)
...
class DownLayer(SequentialModuleListMixin):
    ...
    This consists of:
    1. A series of ConditionalWResBlock instances
    2. An optional DownCondWResnetBlock if downsampling is enabled
    ...
    def __init__(
        ...
        for i in range(num_resnet_blocks - 1):
            resnet_blocks[i] = ConditionalWResBlock(
        ...
        resnet_blocks[num_resnet_blocks - 1] = DownCondWResnetBlock(
...
class UpLayer(SequentialModuleListMixin):
    ...
    def __init__(
        ...
        resnet_blocks[-1] = UpCondWResnetBlock(
