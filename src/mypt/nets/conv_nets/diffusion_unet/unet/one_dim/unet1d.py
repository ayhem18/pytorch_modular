...
class UNet1DCond(AbstractUNetCond):
    ...
    def build_up_block(
        ...
        # the up block output channels are the skip connections channels plus the final output channel
        up_out_channels = common_block_channels + [self.final_out_channels]
