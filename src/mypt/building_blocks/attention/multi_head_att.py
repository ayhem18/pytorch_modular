...
class AbstractMHAttentionLayer(NonSequentialModuleMixin, nn.Module, abc.ABC):
    ...
    def create_final_mask(self, default_mask: torch.Tensor, pad_mask: Optional[torch.Tensor] = None) -> torch.Tensor:
    ...
    def forward(self, x: torch.Tensor, mask: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        # the default mask would be a causal mask for the CausalAttentionLayer and an all-ones mask for the BidirectionalAttentionLayer
