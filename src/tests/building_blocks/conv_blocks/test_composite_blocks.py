...
from mypt.building_blocks.conv_blocks.composite_blocks import ContractingBlock
...
class TestContractingBlock(CustomModuleBaseTest):
    ...
    #             x1 = torch.randn(2, *input_shape)
    #             x2 = torch.randn(2, *input_shape)
    ...
    #             expected_shape = (2, *output_shape)
    #             self.assertEqual(tuple(output1.shape), expected_shape)
    #             self.assertEqual(tuple(output2.shape), expected_shape)
