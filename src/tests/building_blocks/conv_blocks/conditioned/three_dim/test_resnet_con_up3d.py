...
class TestUpCondThreeDimWResBlock(CustomModuleBaseTest):
    ...
    def _generate_random_upcond_block(self,
                                      ...
                                      dropout_rate=None,
                                      upsample_type=None,
                                      inner_dim=None) -> UpCondThreeDimWResBlock:
        """Generate a random UpCondThreeDimWResBlock with given or random parameters"""
        ...
        # Create the block
        return UpCondThreeDimWResBlock(
            in_channels=in_channels,
            out_channels=out_channels,
            cond_dimension=cond_dimension,
            inner_dim=inner_dim,
            stride=1,  # 3D blocks support stride parameter
    ...
    def test_upcond_block_structure(self):
        """Test that UpCondThreeDimWResBlock is structured correctly"""
        for _ in range(100):
